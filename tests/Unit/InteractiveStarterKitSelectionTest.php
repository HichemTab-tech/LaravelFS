...
class DummyInteractiveSelectionCommand extends NewCommand
{
     ...
     */
    public function simulateInteractiveSelection(string $choice, ArrayInput $input): void {
        match ($choice) {
